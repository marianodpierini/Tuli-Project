...
from core.improved_context_classes import EnhancedUserContext, CustomJSONEncoder, LanggraphManager
...
class ApiRequestHandler(RequestHandler):
    ...
    def handle_event(self):
        try:
            ...
            sql_agent = SqlAgent(self.logger, self.user_context, client, agent_responses_feedback, config, self.user_context.session_id, SessionLocal, source)
            rag_agent = RagAgent(self.logger, self.user_context, client, agent_responses_feedback, config, self.user_context.session_id, SessionLocal, source)
